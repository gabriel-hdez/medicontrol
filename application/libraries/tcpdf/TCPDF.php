...
class TCPDF {
	...
	/*public function Header() {
		if ($this->header_xobjid === false) {
			...
			$this->SetX('200');
			$this->Cell($cw, $cell_height, $headerdata['string'], 0, 1, '', 0, '', 1);
			// header title
	...
	public function Header() {
		// Logo
		/*$image_file = K_PATH_IMAGES.'medicontrol.png';
		$this->Image($image_file, 12, 12, 20, '', 'PNG', '', 'T', false, 300, '', 0, false, false, false, false, false);
		// Set font
		$this->SetFont('helvetica', 'B', 12);
		$this->SetY(15);
		$this->SetX(35);
		// Title
		$this->Cell(0, 12, 'MEDICONTROL', 0, 1, 'R', 0, '', 0, false, 'M', 'M');
		...
		$this->Image($img_file, 0, 0, 267, 330, '', '', 'T', false, 300, '', false, false, 0);*/
	...
	public function Footer() {
		...
		$this->SetFont('helvetica', 'I', 8);
		// Page number
		/*$this->Cell(0, 0, $_SESSION['login']['direccion'], 0, 1, 'C', 0, '', 0, false, 'T', 'M');
		$this->Cell(0, 0, $_SESSION['login']['informacion'], 0, 1, 'C', 0, '', 0, false, 'T', 'M');*/
		
		$this->Cell(0, 8, 'Pagina '.$this->getAliasNumPage().'/'.$this->getAliasNbPages(), 0, false, 'R', 0, '', 0, false, 'T', 'M');
	}
