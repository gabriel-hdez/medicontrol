...
?>
    ...
    <form data-response="json" method="POST" action="<?php echo base_url('citas/solicitar/actualizar');?>">
        <input type="hidden" name="token" value="aprobacion">
        ...
        <div class="row">
            <div class="input-field col s12 l4">
                ...
                <label for="clave">CONFIRMA CON TU CONTRASEÑA</label>
                <span class="helper-text" data-success="¡Se ve bien!"></span>
            </div>
            <?php if($cita->aprobacion == '0000-00-00'): ?>
                <div class="col s12 l4 input-field">
                    <input id="fecha_asignada" name="fecha_asignada" type="text" class="validate datepicker habilitar" >
                    <label for="fecha_asignada">FECHA ASIGNADA</label>
                    <span class="helper-text" data-error="" data-success="¡Se ve bien!"></span>
                </div>         
                <div class="col s12 l4 input-field">
                    <input id="hora_asignada" name="hora_asignada" type="text" class="validate timepicker habilitar" value="<?php echo $cita->hora_asignada; ?>" data-url="<?php echo base_url('citas/solicitar/horas'); ?>" >
                    <label for="hora_asignada">HORA ASIGNADA</label>
                    <span class="helper-text" data-error="" data-success="¡Se ve bien!"></span>
                </div>
            <?php endif;?>
        ...
        <div class="row titulo">
            <h5 class="center" >Datos de la solicitud de cita</h5>
        </div>
        <div class="row">
            <div class="col s12 l4 input-field">
