...
?>
    ...
    <form data-response="json" method="POST" action="<?php echo base_url('citas/solicitar/actualizar');?>">
        ...
        <div class="row">
            <div class="col s12 l4 input-field">
                <input id="fecha_solicitud" name="fecha_solicitud" type="text" class="validate datepicker habilitar" value="<?php echo $cita->fecha_solicitud; ?>"  >
                <label for="fecha_solicitud">FECHA SOLICITUD</label>
                <span class="helper-text" data-error="" data-success="¡Se ve bien!"></span>
            </div>         
            <div class="col s12 l4 input-field">
                <input id="hora_solicitud" name="hora_solicitud" type="text" class="validate timepicker habilitar" value="<?php echo $cita->hora_solicitud; ?>" data-url="<?php echo base_url('citas/solicitar/horas'); ?>"  >
