	    ...
	    <div class="col s12 m8 l6 push-m2 push-l3">
	    	<div class="card z-depth-4" style="background-color: rgba(255,255,255, 0.7);">
	    		<div class="card-content">
			      ...
			      <img class="center-block" src="<?php echo base_url('app/assets/img/medicontrol/medicontrol.png');?>" width="35%" alt="<?php echo APP_FULLNAME; ?>" >
			      
			      
			      <div class="row center">
							    <div class="col s12">
							      <!-- <ul class="tabs">
							        <li class="tab"><a href="#test1" class="active">PACIENTE</a></li>
							        <li class="tab"><a href="#test2">MEDICO</a></li>
							        <li class="tab"><a href="#test3">DIRECTIVO</a></li>
							      </ul> -->
							    </div>
							    ...
							    <div id="test1" class="col s12">
						            ...
						            <div class="row">
						                <div class="col s12 center">
						                    <button type="submit" class="waves-effect waves-light btn blue btn-large" >INICIAR SESIÓN</button>
						                
						                    <a href="#" class="waves-effect waves-light btn blue btn-large" >REGISTRATE</a>
						                </div>
						            </div>
							      </form>
							    </div>
						...
						<div class="row">	
	            <div class="col s12 center">
	                <a class="waves-effect waves-light btn-flat btn-large modal-close" href="<?php echo base_url('seguridad/clave');?>">¿OLVIDASTE TU CONTRASEÑA?</a>
	            </div>
						</div>       
	    		</div>
	    		</div>
