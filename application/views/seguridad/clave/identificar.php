			      ...
			      <img class="center-block" src="<?php echo base_url('app/assets/img/medicontrol/medicontrol.png');?>" width="25%" alt="<?php echo APP_FULLNAME; ?>" >
						...
						<div class="height" >			
					      ...
					      <div class="row container">
							    <div class="col s12">
							      <ul class="tabs">
							        <li class="tab col s4"><a class="active" >IDENTIFICAR USUARIO</a></li>
					        	...
					        	<form data-response="json" method="POST" action="<?php echo base_url('seguridad/clave/identificar'); ?>">
							        <div class="row" style="margin-top: 2rem;">
								        ...
								        <div class="col s12 center">
								        	<button type="submit" class="waves-effect waves-light btn blue btn-large">IDENTIFICAR</button>
								        	<a class="waves-effect waves-light btn-flat" href="<?php echo base_url('inicio/logout');?>">CANCELAR</a>
								        </div>
							        </div>        
					        	</form>
							    </div>
