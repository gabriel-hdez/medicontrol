					      ...
					      <div class="row container">
							    <div class="col s12">
							      <ul class="tabs">
							        ...
							        <li class="tab col s4 disabled"><a >PREGUNTA DE SEGURIDAD</a></li>
							        <li class="tab col s4"><a class="active">CAMBIAR CONTRASEÑA</a></li>
							      </ul>
							    </div>

							    <div id="test2" class="col s12">
							    	<h5 class="blue-grey-text text-darken-2 center"><?php echo $_SESSION['usuario']['usuario']?></h5>

						        	<form data-response="json" method="POST" action="<?php echo base_url('seguridad/clave/actualizar'); ?>">
									    ...
									    <div class="row">
									        <div class="input-field col s12 m8 push-m2">
									        	<i class="material-icons prefix blue-grey-text text-darken-3 password" data-visibility="off">visibility</i>
									          <input id="repetir" name="repetir" type="password" class="validate" style="background: transparent !important;">
									        ...
									        <div class="col s12 center">
									        	<button type="submit" class="waves-effect waves-light btn blue btn-large ">ACTUALIZAR</button>
									        </div>
								        </div>        
						        	</form>
 ...
 <footer class="page-footer blue-grey darken-4">
	...
	<script>
		$(document).ready(function(){
		    $('.tabs').tabs();
		    M.toast({html: "<?php  echo 'Ya puedes cambiar tu contraseña '.$_SESSION['usuario']['correo']?>"})
