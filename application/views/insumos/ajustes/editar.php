...
?>
    ...
    <form data-response="json" method="POST" action="<?php echo base_url('insumos/ajustes/actualizar');?>">
        ...
        <div class="row">
            ...
            <div class="col s12 l4 input-field">
                <input id="cantidad" name="cantidad" type="text" class="validate decimal" placeholder="0.00" value="<?php echo $ajuste->cantidad; ?>">
                <label for="cantidad">CANTIDAD</label>
                <span class="helper-text" data-error="" data-success="¡Se ve bien!"></span>
            </div>

             <div class="col s12 l4 input-field">
                <input id="fecha_vencimiento" name="fecha_vencimiento" type="text" class="validate datepicker" placeholder="<?php echo date('Y-m-d');?>" value="<?php echo $ajuste->fecha_vencimiento; ?>" >
                <label for="fecha_vencimiento">FECHA DE VENCIMIENTO</label>
                <span class="helper-text" data-error="" data-success="¡Se ve bien!"></span>
            </div>

            <div class="col s12 l4 input-field">
                <input id="descripcion" name="descripcion" type="text" class="validate" value="<?php echo $ajuste->descripcion; ?>">
