...
?>
   ...
   <form data-response="json" method="POST" action="<?php echo base_url('registros/personal/actualizar');?>">
        ...
        <input type="hidden" name="id" value="<?php echo $personal->id_detalle_usuario?>">
         ...
         <div class="row">
            ...
            <div class="col s12 l4 input-field">
                <input id="cedula" name="cedula" type="text" class="validate simple-field-data-mask" data-mask="00000000" placeholder="12345678" value="<?php echo $personal->cedula; ?>" disabled >
                <label for="cedula">CEDULA</label>
                <span class="helper-text" data-error="" data-success="¡Se ve bien!"></span>
            </div>  
            <div class="col s12 l4 input-field">
                <input id="fecha_nacimiento" name="fecha_nacimiento" type="text" class="validate datepicker" onchange="validarEdad()" placeholder="1999-01-01" value="<?php echo $personal->fecha_nacimiento; ?>" disabled >
        ...
        <div class="row">
            <div class="col s12 l4 input-field">
                <input id="nombres" name="nombres" type="text" class="validate" placeholder="Pedro Jose" value="<?php echo $personal->nombres; ?>" disabled >
                <label for="nombres">NOMBRES</label>
                <span class="helper-text" data-error="" data-success="¡Se ve bien!"></span>
            </div>
            <div class="col s12 l4 input-field">
                <input id="apellidos" name="apellidos" type="text" class="validate" placeholder="Perez Gonzalez" value="<?php echo $personal->apellidos; ?>" disabled >
        ...
        <div class="row">
            <div class="col s12 l4 input-field">
                <input id="correo" name="correo" type="text" class="validate" placeholder="pedro@correo.com" value="<?php echo $personal->correo; ?>" disabled >
                <label for="correo">CORREO ELECTRÓNICO</label>
                <span class="helper-text" data-error="" data-success="¡Se ve bien!"></span>
            </div>
            <div class="col s12 l4 input-field">
                <input id="tlf" name="tlf" type="text" class="validate simple-field-data-mask" data-mask="0000-0000000" placeholder="1234-1234567" value="<?php echo $personal->tlf; ?>" disabled >
        ...
        <div class="row">
            ...
            <div class="col s12 l4 input-field">
                <input id="direccion" name="direccion" type="text" class="validate" value="<?php echo $personal->direccion1; ?>" disabled >
        ...
        <div class="row">
            <div class="col s12 l4 input-field">
                <input id="colegiatura" name="colegiatura" type="text" class="validate" value="<?php echo $personal->colegiatura; ?>" disabled >
                <label for="colegiatura">NUMERO COLEGIADO</label>
                <span class="helper-text" data-error="" data-success="¡Se ve bien!"></span>
            </div>
            <div class="col s12 l4 input-field">
                <select name="id_institucion" id="id_institucion" class="select2 browser-default select-anidado" data-url="<?php echo base_url('registros/personal/perfiles/select-perfil'); ?>" disabled >
            ...
            <div class="col s12 l4 input-field">
                <select name="id_perfil" id="id_perfil" class="select2 browser-default select-perfil" disabled >
