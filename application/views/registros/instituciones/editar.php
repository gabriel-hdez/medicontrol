...
?>
    ...
    <form data-response="json" method="POST" action="<?php echo base_url('registros/instituciones/actualizar');?>">
        ...
        <div class="row">
            ...
            <div class="col s12 l4 input-field">
                <input id="rif" name="rif" type="text" class="validate simple-field-data-mask" data-mask="00000000-0" placeholder="12345678-9" value="<?php echo $institucion->rif; ?>">
                <label for="rif">RIF</label>
                <span class="helper-text" data-error="" data-success="¡Se ve bien!">Campo obligatorio</span>
            </div>
            <div class="col s12 l4 input-field">
                <input id="institucion" name="institucion" type="text" class="validate" placeholder="Nombre de la institucion" value="<?php echo $institucion->institucion; ?>">
        ...
        <div class="row">            
            <div class="col s12 l4 input-field">
                <input id="correo" name="correo" type="text" class="validate" placeholder="institucion@correo.com" value="<?php echo $institucion->correo; ?>">
                <label for="correo">CORREO ELECTRÓNICO</label>
                <span class="helper-text" data-error="" data-success="¡Se ve bien!"></span>
            </div>
            <div class="col s12 l4 input-field">
                <input id="tlf" name="tlf" type="text" class="validate simple-field-data-mask" data-mask="0000-0000000" placeholder="1234-1234567" value="<?php echo $institucion->tlf; ?>">
        ...
        <div class="row">
            ...
            <div class="col s12 l4 input-field">
                <input id="direccion" name="direccion" type="text" class="validate"  value="<?php echo $institucion->direccion; ?>">
