...
(function( $, window, document, undefined ) {
  ...
  //       	+'</div>';
		...
		var input = '<div class="nav-wrapper transparent z-depth-2 no-imprimir col s6 m4 l3" style="float:right; margin-bottom:2rem;">'
	...
	function _fnFeatureHtmlLength ( settings )
	{
		...
		var div = $('<div><div style="position:relative; z-index:2; height:1px;"/></div>').addClass( classes.sLength );
	...
	$.extend( DataTable.ext.classes, {
		...
		"sPaging": "dataTables_paginate no-imprimir paging_", /* Note that the type is postfixed */
